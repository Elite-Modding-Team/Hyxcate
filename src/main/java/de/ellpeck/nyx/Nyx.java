...
@Mod(modid = Nyx.ID, name = Nyx.NAME, version = Nyx.VERSION, dependencies = "required-after:mixinbooter@[10.2,);required-after:expandedevents;after:tconstruct;after:conarm")
public class Nyx {
