...
public class NyxBlocks {
    ...
    public static void onBlockRegistry(RegistryEvent.Register<Block> event) {
        ...
        reg.registerAll(
                ...
                meteoriteRock = initBlock(new NyxBlockMeteorRock(() -> NyxItems.meteoriteShard, EnumParticleTypes.SUSPENDED_DEPTH, SoundType.STONE, 3).setHardness(4.0F).setResistance(2000.0F), "meteorite_rock", ItemBlock::new),
