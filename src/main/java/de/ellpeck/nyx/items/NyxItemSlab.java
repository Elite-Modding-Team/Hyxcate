...
import de.ellpeck.nyx.blocks.NyxBlockSlab;
...
public class NyxItemSlab extends ItemBlock {

    private final Supplier<NyxBlockSlab> singleSlab;
    private final Supplier<NyxBlockSlab> doubleSlab;

    public NyxItemSlab(Block block, Supplier<NyxBlockSlab> singleSlab, Supplier<NyxBlockSlab> doubleSlab) {
        super(block);
