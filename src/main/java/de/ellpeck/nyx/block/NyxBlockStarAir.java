...
import de.ellpeck.nyx.item.NyxItemFallenStar;
...
public class NyxBlockStarAir extends BlockContainer {
    public NyxBlockStarAir() {
        super(Material.AIR);
        NyxBlocks.initBlock(this, "star_air", null);
